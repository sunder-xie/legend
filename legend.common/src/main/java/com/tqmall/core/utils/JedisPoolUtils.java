...
public class JedisPoolUtils {
     ...
     * Jeids db select
     */
    private static Integer dbIndex = 11;
     ...
     * @param jedis
     */
    public static void returnSlaveBrokenRes(Jedis jedis) {
     ...
     * @param jedis
     */
    public static void returnMasterBrokenRes(Jedis jedis) {
    ...
    public static void setDbIndex(Integer dbIndex) {
        JedisPoolUtils.dbIndex = dbIndex;
    }
}
