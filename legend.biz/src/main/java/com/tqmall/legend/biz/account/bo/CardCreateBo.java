...
public class CardCreateBo {
    ...
    private Map<Long, BigDecimal> serviceCatRels;
    private List<GoodsCatBo> goodsCats;
    ...
    public Map<Long, BigDecimal> getServiceCatRels() {
        return serviceCatRels;
    }

    public void setServiceCatRels(Map<Long, BigDecimal> serviceCatRels) {
        this.serviceCatRels = serviceCatRels;
    }

    public List<GoodsCatBo> getGoodsCats() {
        return goodsCats;
    }

    public void setGoodsCats(List<GoodsCatBo> goodsCats) {
