 ...
 * 门店活动,公告推送到车主app
 */
public class MessagePlatformRechargeCzApp {

    Logger logger = LoggerFactory.getLogger(MessagePlatformRechargeCzApp.class);
    @Getter
    @Setter
    private String host;
    @Getter
    ...
    public void pushMsgToRechargeCzApp(Map<String, Object> message) {
        sendMessage(routingKey, defaultExchange, message);
        logger.info("push门店会员卡充值信息到车主app端成功! 推送信息是:{}", message);
