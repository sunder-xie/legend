        ...
        <div class="activityEdit">
            <div class="activityInfo">
                <div>
                    ...
                    <input type="text" class="counter" data-maxcount="20" id="actName">
                    <input type="hidden" id="actId">
                    <span class="showCount">限20字</span>
                </div>
                <div>
                    <span class="redTips">活动简介：</span>
                    <textarea rows="3" cols="20" class="counter" data-maxcount="40" id="actDesc" placeholder="活动转发和通知时显示的亮点"></textarea>
            ...
            <div class="banner">
                ...
                <div class="imgList">
                    <div class="uploadImg">
                        <a href="javascript:;" class="img_del_btn"></a>
                        <input type="file" id="uploadBanner"/>
                        <img class="bannerImg" id="bannerImg" src=""/>
                        +
                    </div>
                </div>
            </div>
            <div class="activitySet">
                <div class="activityTime">
                    ...
                    <input id="startTime" class="Wdate" type="text" onfocus="WdatePicker({minDate: '%y-%M-%d' })" placeholder="默认当天"/>
                    至
                    <input id="endTime" class="Wdate" type="text" onfocus="WdatePicker({minDate: '%y-%M-%d' })" placeholder="永久"/>
                </div>
                <div class="activityTypeList">
                    ...
                    <div class="typeList">
                        <#list activityTypeList as t>
                            ...
                            <div class="activityType <#if ok>typeChecked</#if>" data-id="${t.id}">${t.name}</div>
                        </#list>
                    </div>
                </div>
                <div class="activityIndex">
                    ...
                    <div class="wordEdit">
                        ...
                        <script type="text/plain" id="detailDesc"></script>
                    </div>
                </div>
            </div>
        </div>
        <div class="operateBtns">
            <a  class="activityOperate save">保存</a>
        </div>
    </div>
</div>
