<#--试车单-->
<section class="print-box car-test-box" data-print="car-test">
    <header>
    <#if printLogo != null>
    ...
    <#elseif SESSION_SHOP_LEVEL != 10 && SESSION_SHOP_LEVEL != 11 && SESSION_SHOP_LEVEL != 12 && printTitle == null>
        ...
        <h2 class="text" id="编号">（试车单） NO：<i class="text"></i></h2>
    ...
    <article>
        ...
        <div class="info-box box">
            <div class="left">
                <ul>
                <li id="车牌"><i>车牌：</i><i class="text"></i></li>
                <li id="工单号"><i>工单号：</i><i class="text"></i></li>
                    </ul>
                <ul>
