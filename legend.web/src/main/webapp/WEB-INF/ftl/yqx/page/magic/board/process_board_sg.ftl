...
<#include "yqx/layout/kb-aside.ftl">
    <div class="main">
        <div class="title clearfix">
            <p class="title_name fl">事故线工序看板</p>
            <ul class="sumary fr">
                <li>全部（50）</li>
                <li><span class="icon-wait icon-sumary fl"></span>滞留（25）</li>
        ...
        <div class="loadplate">
            <ul class="flow-col-4">
                ...
                <li class="flow-plate banjin-plate">
                    <p class="plate-top b2">钣金（14）</p>
                    <ul class="plate-list banjin-list">
                        <li>
                ...
                <li class="flow-plate zuodi-plate">
                    <p class="plate-top b3">做底（14）</p>
                    <ul class="plate-list zuodi-list">
                        <li>
                            <span class="icon-timeout icon-state"></span>
                            <P class="f14 c3">浙A LY344</P>
                            <p>接待员：罗永浩</p>
                ...
                <li class="flow-plate zhongtu-plate">
                    <p class="plate-top b4">中涂（14）</p>
                    <ul class="plate-list zhongtu-list">
                        <li>
                            <span class="icon-timeout icon-state"></span>
                            <P class="f14 c3">浙A LY344</P>
                            <p>接待员：罗永浩</p>
                ...
                <li class="flow-plate mianqi-plate">
                    <p class="plate-top b5">面漆（14）</p>
                    <ul class="plate-list mianqi-list">
                        <li>
                            <span class="icon-timeout icon-state"></span>
                            <P class="f14 c3">浙A LY344</P>
                            <p>接待员：罗永浩</p>
                ...
                <li class="flow-plate paoguang-plate">
                    <p class="plate-top b6">抛光（14）</p>
                    <ul class="plate-list paoguang-list">
                        <li>
                            <span class="icon-timeout icon-state"></span>
                            <P class="f14 c3">浙A LY344</P>
                            <p>接待员：罗永浩</p>
