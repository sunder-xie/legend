...
<link rel="stylesheet" href="${BASE_PATH}/static/css/page/ax_insurance/virtual/card-select.css?8a2dc79bcc449cb5fa4b29a4dd5a4df9">
    ...
    <div class="main" id="newMain">
        ...
        <div class="main-body panel">
            <div class="panel-header">
                <div class="row">
                    <label class="text-label">订单号：</label><strong class="mark-1 divide" name="orderSn">${orderSn}</strong>
                    <label class="text-label">支付金额：</label><strong class="mark-2" name="totalFee"><#if totalFee??>#{totalFee;m2M2}</#if></strong>
                </div>
...
<script src="${BASE_PATH}/static/js/page/ax_insurance/virtual/card-select.js?d7bcc5826e2c7a1250b137b7afc6fc0b"></script>
