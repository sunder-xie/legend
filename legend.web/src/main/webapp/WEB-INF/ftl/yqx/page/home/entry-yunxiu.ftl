<#if SESSION_ANXIN_INSURANCE_CITY_IS_OPEN == "true">
    <#-- 推荐汽车保险的云修生态磁贴 -->
    <#include "yqx/page/home/entry-yunxiu-insurance.ftl">
<#else>
<#-- 普通云修生态磁贴 -->
<div class="main">
    <div class="entry">
        ...
        <#if YBD=="true">
            <a class="entry-item marketing"
               href="${BASE_PATH}/marketing?refer=yunxiu-home">
            <#else>
        ...
        <a class="entry-item activity-1 js-check-func" href="javascript:void(0)"
    ...
    <#-- start -->
        <a class="entry-item subscription-1" href="javascript:;">
            <div class="circle-1">
                <div class="transform-box">
                    <div class="icon"></div>
                </div>
        ...
        <a class="entry-item app-1" href="javascript:void(0)">
            <div class="circle-1">
                <div class="transform-box">
                    <div class="icon"></div>
                </div>
        ...
        <a class="entry-item epc" target="_blank" href="${BASE_PATH}/home/avoid/epc/index?refer=yunxiu-home">
            <div class="circle-1">
                <div class="transform-box">
                    <div class="icon"></div>
                </div>
