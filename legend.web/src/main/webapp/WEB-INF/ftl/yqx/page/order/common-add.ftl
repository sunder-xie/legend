...
<div class="yqx-wrapper clearfix">
    ...
    <div class="order-right fl">
        ...
        <div class="order-form mb10 base-box">
            ...
            <div class="show-grid">
                <div class="col-6">
                    <div class="form-label">车型</div><div class="form-item form-data-width">
                        <input type="text"
                               class="yqx-input"
                               name="carModeBak"
            ...
            <div class="show-grid">
                ...
                <div class="col-6">
                    <div class="form-label">预计完工日期</div><div class="form-item form-data-width">
                        <input type="text" class="yqx-input yqx-input-icon js-expected-time"
                               name="orderInfo.expectedTime"
                               title="预计完工日期"
                               value="<#if (orderInfo.expectedTimeYMD)>${orderInfo.expectedTimeYMD}</#if>"
                    ...
                    <div class="col-3">
                        <div class="form-label">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="">
                            <input type="hidden" name="orderInfo.orderType"
                    ...
                    <div class="col-6">
                        <div class="form-label">
                            ...
                            <input type="text"
                                   ...
                                   class="yqx-input js-show-tips"
                                   title="客户单位"
                                   value="${orderInfo.company}" disabled>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="order-panel-body">
                        ...
                        <tr class="goods-datatr">
                            ...
                            <td>
                                <div class="form-item">
                                    ...
                                    <i class="fa icon-small">${orderGoods.measureUnit}</i>
                                </div>
                            </td>
                            <!--金额-->
                            <td>
                ...
                <div class="show-grid">
                    <div class="form-label form-label-remark">备注</div><div class="form-item form-item-remark">
                        <input class="yqx-input js-show-tips" name="orderInfo.postscript" placeholder="请填写备注信息" data-v-type="maxLength:200" value="${orderInfo.postscript}" />
                    </div>
                </div>
                <div class="show-grid">
                    <div>
    ...
    <tr class="service-datatr" data-id="<%=orderService.id%>">
        ...
        <td>
            <div class="form-item">
                ...
                <input type="hidden" name="serviceSn" value="<%=orderService.serviceSn%>"/>
                <input type="hidden" name="parentServiceId"
                       value="<%if(parentService){%><%= parentService.id%><%}else{%>0<%}%>"/>
                <!-- 基础服务类型 -->
