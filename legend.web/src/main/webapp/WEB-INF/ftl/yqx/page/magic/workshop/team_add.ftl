...
<link rel="stylesheet" href="${BASE_PATH}/static/css/page/magic/workshop/team-add.css?6fc78c920c92f9191cb60bd1f3be592a"/>
<!-- 样式引入区 end-->
            ...
            <div class="yqx-group-content">
                ...
                <div class="shareholder-box clearfix">
                    ...
                    <div class="sharholder fr">
                        <div class="sh-title"><span>已添加成员</span>(单机移除)</div>
                        <div class="sh-con">
...
<script type="text/html" id="LeftBoxTpl">
    ...
    <%if(json.data.shopManagerExtVOList){%>
...
<!-- 脚本引入区 start -->
<script  src="${BASE_PATH}/static/js/page/magic/workshop/team-add.js?33152ac961e5996b751b88dfac73d136"></script>
<!-- 脚本引入区 end -->
