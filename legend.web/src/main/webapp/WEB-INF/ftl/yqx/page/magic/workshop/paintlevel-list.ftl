...
<link rel="stylesheet" href="${BASE_PATH}/static/css/page/magic/workshop/paintlevel-list.css?4426bbed15ceacae4e847088b56ae558"/>
<!-- 样式引入区 end-->
<div class="yqx-wrapper clearfix">
    ...
    <div class="order-right fl">
        <div class="table_title clearfix">
            <p class="fl title">面漆级别设置</p>
            <p class="fr yqx-btn yqx-btn-1 add"><span class="icon-add">﹢</span>新增级别</p>
        </div>
        <!-- 表格容器 start -->
    ...
    <div class="dialog">
        ...
        <ul class="dialog-con">
            <li>
                ...
                <div class="form-item">
                    <input type="text" name="pname" class="yqx-input" value="" placeholder="" data-v-type="required">
                </div>
            </li>
            <li>
    ...
    <div class="dialog">
        ...
        <ul class="dialog-con">
            <li>
                ...
                <div class="form-item">
                    <input type="text" name="pname" class="yqx-input" value="<%=json.name%>" placeholder="" data-v-type="required">
                </div>
            </li>
            <li>
                <div class="form-label">
...
<!-- 脚本引入区 start -->
<script  src="${BASE_PATH}/static/js/page/magic/workshop/paintlevel-list.js?f36c6a215177560a7eb24751190e248c"></script>
<!-- 脚本引入区 end -->
