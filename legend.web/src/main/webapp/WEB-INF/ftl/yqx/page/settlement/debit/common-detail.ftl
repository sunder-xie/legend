...
<link rel="stylesheet" href="${BASE_PATH}/static/css/page/settlement/debit/common-detail.css?c0926acee1bd9e9d50cbd9b4e70a5b21"/>
<!-- 样式引入区 end-->
    ...
    <div class="order-right fl">
        ...
        <div class="detail-box">
            <div class="show-grid bold">
                ...
                <div class="form-item">
                    <div class="yqx-text">
                    ${orderInfo.orderSn}（开单日期： <#if orderInfo.createTime>${orderInfo.createTime?string("yyyy-MM-dd HH:mm")}</#if>）
                        <!--<#if orderInfo.orderStatus == 'DDYFK'>
                        <a href="javascript:;" class="redorder js-red-order"><#if redBill>查看冲红单<#else>+ 冲红单</#if></a>
                        </#if>-->
                    </div>
                </div>
            </div>
            ...
            <div class="show-grid">
                <div class="col-4">
                    <div class="form-label form-label-width">业务类型：</div>
                    <div class="form-item">
                        <div class="yqx-text form-item-width">
            ...
            <div class="table-box">
                ...
                <table class="yqx-table">
                    ...
                    <tr class="form_item">
                        ...
                        <td class="td-right">
                            <div class="max-text js-show-tips">${orderService.servicePrice}</div>
                        </td>
        ...
        <#if additionalServices>
            <div class="table-box">
                ...
                <p>附加总费用：<span class="money-font white">&yen;${orderInfo.feeAmount}</span> - 附加总优惠：<span class="money-font white">&yen;${orderInfo.feeDiscount}</span> = 附加费用：<span class="money-font white">&yen;${orderInfo.feeAmount-orderInfo.feeDiscount}</span></p>
            </div>
        </#if>
        </div>
        <!-- 表格详情 end-->
        ...
        <#if orderInfo.postscript >
            ...
            <div class="bot-text">总计：
                <span class="money-font">&yen; ${orderInfo.orderAmount}</span>
        ...
        <#if debitBill>
            <div class="bot-text">应收金额：
                ...
                <div class="total-details-tag js-tag"></div>
                <div class="total-hide hide">
                    <div class="total-arrow"></div><div class="total-details">总计：<span class="money-font white">&yen;${orderInfo.orderAmount}<#if orderInfo.taxAmount gt 0></span> + 费用：<span class="money-font white">&yen;${orderInfo.taxAmount}</#if></span> - 优惠总金额：<span class="money-font white">&yen;${orderInfo.orderDiscountAmount}</span> = 应收金额：<span class="money-font white">&yen; ${debitBill.receivableAmount}</span></div>
                </div>
            </div>
        ...
        <#if redBill>
            <div class="bot-text">冲红应收金额：
                <span class="money-font">&yen; ${redBill.receivableAmount}</span>
            </div>
        </#if>
            ...
            <#if redBill && redBill.paidAmount < 0>
                <div class="bot-text">冲红实收金额：
                    <span class="money-font">&yen; ${redBill.paidAmount}</span>
                </div>
            </#if>
            <div class="bot-text">挂账金额：
                ...
                <div class="total-details-tag js-tag"></div>
                <div class="total-hide hide">
                    <div class="total-arrow"></div><div class="total-details">应收金额：<span class="money-font white"> &yen;${debitBill.receivableAmount}</span>
                        -　实收金额：<span class="money-font white">&yen;${debitBill.paidAmount}</span>  <#if debitBill.badAmount gt 0> - 坏账金额：<span class="money-font white"> &yen;${debitBill.badAmount}</span></#if>  = 挂账金额：<span class="money-font white">&yen;${debitBill.signAmount}</span></div>
                </div>
            </div>
            <#if redBill && redBill.signAmount < 0>
                <div class="bot-text">冲红挂账金额：
                    <span class="money-font">&yen; ${redBill.signAmount}</span>
                </div>
            </#if>
            ...
            <#if redBill && redBill.badAmount < 0>
                <div class="bot-text">冲红坏账金额：
                    <span class="money-font">&yen; ${redBill.badAmount}</span>
                </div>
            </#if>
        </#if>
        ...
        <#if orderInfo.payStatus !=0>
            <!-- 受托工单统一批量收款，不单个收 -->
            <#if orderInfo.payStatus ==1 && orderInfo.proxyType !=2>
        ...
        <#elseif orderInfo.payStatus ==0 && orderInfo.orderStatus == 'DDWC' && orderInfo.proxyType != 2>
            <button class="yqx-btn yqx-btn-2 yqx-btn-small js-confirm">确认账单</button>
            <button class="yqx-btn yqx-btn-1 yqx-btn-small js-ticket">开票</button>
        </#if>
...
<script  src="${BASE_PATH}/static/js/page/settlement/debit/common-detail.js?6c88dd923e3329309646548a3e00d58f"></script>
<!-- 脚本引入区 end -->
