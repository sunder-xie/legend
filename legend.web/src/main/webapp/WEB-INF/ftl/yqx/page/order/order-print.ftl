...
<table class="costomInfoTable" cellspacing="0" cellpadding="0">
    <tr>
        <td class="dInfo">
            ...
            <div class="td" style="width:103px;">预完工日期：</div>
            <div class="td"
                 style="width:148px; text-align: center;"><#if orderInfo.expectedTime>${orderInfo.expectedTime?string("yyyy-MM-dd HH:mm")}</#if></div>
            <div class="td" style="width:85px;">维修类别：</div>
            <div class="td" style="width:100px; text-align: center;">${orderInfo.orderTypeName}</div>
        </td>
    </tr>
    <tr>
        <td class="dInfo">
            <div class="td" style="width:85px;">VIN 码：</div>
            <div class="td" style="width:195px; text-align: center;">${orderInfo.vin}</div>
            <div class="td" style="width:103px;text-align: center;">发动机号：</div>
            <div class="td" style="width:148px; text-align: center;">${orderInfo.engineNo}</div>
            <div class="td" style="width:103px;">车辆颜色：</div>
            <div class="td" style="width:148px; text-align: center;">${orderInfo.carColor}</div>
            <div class="td" style="width:85px;">购车日期：</div>
            <div class="td" style="width:100px; text-align: center;"><#if orderInfo.buyTime>${orderInfo.buyTime?string("yyyy-MM-dd")}</#if></div>
        </td>
    </tr>
    <tr>
        <td class="dInfo">
