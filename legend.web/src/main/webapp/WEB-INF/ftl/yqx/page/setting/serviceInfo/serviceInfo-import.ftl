...
<div class="yqx-wrapper clearfix">
    ...
    <div class="order-right fl">
        ...
        <div class="content">
            <h3>服务项目可以一键导入，轻松搞定上百条服务项目</h3>
            <div class="step-box">
                <div class="step-title"><i class="radio-box red"></i><span>第一步  准备数据</span></div>
                <p class="step-text">准备好需要导入的服务资料，具体按照模板填写</p>
                <div class="download-box">
                    <a href="${BASE_PATH}/init/import/serviceInfo/template-download" class="yqx-btn yqx-btn-2">下载模版</a>
                ...
                <div class="step-form">
                    <div class="form-item">
                        <input type="text" name="" class="yqx-input yqx-input-small js-file-url" disabled value="" placeholder="服务信息文件">
                    </div>
                    <input type="file" class="file" id="fileBtn" name="excelFile" value="">
                    <button class="yqx-btn yqx-btn-1 yqx-btn-small">选择文件</button>
                    <div class="import-box">
                        <button class="yqx-btn yqx-btn-3 yqx-btn-small js-confirm-import" data-url="${BASE_PATH}/init/import/serviceInfo/import_file" disabled>确认导入</button>
                        <div class="matters">
                            <p>支持多次导入</p>
...
<script type="text/html" id="resultListTpl">
    ...
    <p>成功导入<%=json.data.successNum%>条数据，<br/>
        ...
        未成功导入
        <a href="${BASE_PATH}/upload/excel<%=json.data.fileName%>" class="yqx-link-2">服务列表下载 <img src="${BASE_PATH}/static/img/page/setting/dwon-load.png"></a>
        <%}%>
    </p>
    <%}%>
</script>
