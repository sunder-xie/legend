...
<#if SESSION_SHOP_LEVEL != 10 && SESSION_SHOP_LEVEL != 11 && SESSION_SHOP_LEVEL != 12>
    ...
    <h2 class="text-center text-red">会员卡办理回执单</h2>
    ...
    <div class="car-info">
        <table class="no-border">
            <tr>
                ...
                <td class="col-4 no-float text-center">
                    <i>日期：</i>
                    <i class="text-left">${printObj.dateStr}</i>
                </td>
                <td class="col-4 text-right no-float">
                    <i class="no-float">会员卡号：</i>
                    <i class="ellipsis">${printObj.cardNumber}</i>
                </td>
            </tr>
            <tr>
                <td class="col-4 no-float">
                    <i>车主：</i>
                    <i>${printObj.customerName}</i>
                </td>
                <td class="col-4 no-float text-center">
                    <i>车牌：</i>
                    <i class="text-left">${printObj.carLicenses}</i>
                </td>
                <td class="col-4 no-float text-right">
                    <i>联系电话：</i>
                    <i>${printObj.phone}</i>
                </td>
            </tr>
