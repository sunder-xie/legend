...
<div class="yqx-wrapper clearfix">
    ...
    <div class="order-right fl">
        ...
        <div class="content">
            <h3>计次卡可以一键导入，轻松搞定上百条计次卡信息</h3>
            <div class="step-box">
                <div class="step-title"><i class="radio-box red"></i><span>第一步  准备数据</span></div>
                <p class="step-text">准备好需要导入的计次卡资料，具体按照模板填写</p>
                <div class="download-box">
                    <a href="${BASE_PATH}/init/import/accountCombo/template-download" class="yqx-btn yqx-btn-2">下载模版</a>
                    <div class="matters v-top">
                        <p>注意事项: 1.车主电话必填</p>
                        <p>　　　　　2.若客户信息不存在，需要先导入客户信息</p>
                        <p>　　　　　3.若导入的客户在系统中存在多个客户的情况，请先合并</p>
                        <p>　　　　　4.在系统中查看相应的计次卡类型，若无服务项目，请先创建或导入服务项目</p>
                    </div>
                </div>
                ...
                <div class="step-form">
                    <div class="form-item">
                        <input type="text" name="" class="yqx-input yqx-input-small js-file-url" disabled value="" placeholder="计次卡信息文件">
                    </div>
                    <input type="file" class="file" id="fileBtn" name="excelFile" value="">
                    <button class="yqx-btn yqx-btn-1 yqx-btn-small">选择文件</button>
                    <div class="import-box">
                        <button class="yqx-btn yqx-btn-3 yqx-btn-small js-confirm-import" data-url="${BASE_PATH}/init/import/accountCombo/import_file" disabled>确认导入</button>
                        <div class="matters">
                            <p>支持多次导入</p>
...
<script type="text/html" id="resultListTpl">
    ...
    <p>成功导入<%=json.data.successNum%>条数据，<br/>
        ...
        未成功导入
        <a href="${BASE_PATH}/upload/excel<%=json.data.fileName%>" class="yqx-link-3">计次卡列表下载 <img src="${BASE_PATH}/static/img/page/setting/dwon-load.png"/> </a>
        <%}%>
    </p>
    <%}%>
</script>
