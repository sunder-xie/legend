...
k+'"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr"><div aria-live="assertive" class="dwv'+(p.headerText?"":" dw-hidden")+'"></div>')+'<div class="dwcc clearfix">';a.each(p.wheels,function(c,k){h+='<div class="dwc'+("scroller"!=p.mode?" dwpm":" dwsc dwcsd")+(p.showLabel?"":" dwhl")+'"><div class="dwwc dwrc"><table cellpadding="0" cellspacing="0"><tr>';a.each(k,function(a,c){la[g]=c;b=void 0!==c.label?c.label:a;h+='<td><div class="dwwl dwrc dwwl'+g+'">'+("scroller"!=
...
g++});h+="</tr></table></div></div>"});h+="</div>"+("inline"!=p.display?'<div class="dwbc'+(p.button3?" dwbc-p":"")+'"><span class="dwbw dwb-s"><span class="dwb dwb-e" role="button" tabindex="0">'+p.setText+"</span></span>"+(p.button3?'<span class="dwbw dwb-n" style="display: none"><span class="dwb dwb-e" role="button" tabindex="0">'+p.button3Text+"</span></span>":"")+'<span class="dwbw dwb-c"><span class="dwb dwb-e" role="button" tabindex="0">'+p.cancelText+"</span></span></div></div>":"")+"</div></div></div>";v=a(h);
