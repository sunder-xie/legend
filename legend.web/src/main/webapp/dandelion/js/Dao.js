...
//        });
    ...
    self.App = {
        ...
        gotoHome: function () {
            return isApp && Tqmall.pushToMainView();
        },
        ...
        toDetail: function (goodsId) {
            return isApp && Tqmall.viewProductDetail(goodsId);
        },

        toDetailPage: function(goodsId, cityId, price, actName, version) {
            window.location.href = '/promotion/activity/details/index-act.html?goodsId=' + goodsId
                    + '&userType=0' + '&cityId=' + cityId + '&price=' + price
                    +'&actName=' + actName + "&version=" + (version || 3.0);
        },

        getUserType: function () {
            return isApp && Tqmall.getUserType();
        },
        ...
        goMerchantVerify: function () {
            return isApp && Tqmall.pushToMerchantVerify();
        },
        ...
        setTitle: function (str) {
            return isApp && Tqmall.setTitle(str);
        },

        refreshCart: function () {
            return isApp && Tqmall.pushToCartList();
        },

        addCars: function (arr) {
            return isApp && Tqmall.purse(arr.join());
        },

        alert: function (msg) {
            isApp ? Tqmall.showToast(msg) : alert(msg);
        },
        ...
        iframe2open: function() {
            ...
            if( UA.match(/android/i) ){
                openUrl = "tqmallRepair://yunxiu.com?type=" + pageArgs['type'] + "&&value=" + window.location.href;
        ...
        jump2download: function() {
            ...
            if( UA.match(/android/i) ){
                window.location.href = "http://tqmall-flash.oss-cn-hangzhou.aliyuncs.com/dandelion/taoqiyunxiu_czapp_release.apk?t=" + new Date().getTime();
            } else if( UA.match(/iphone/i) ){
                window.location.href = 'https://itunes.apple.com/us/app/tao-qi-yun-xiu-che-zhu-ban/id1026391647?mt=8';
            }*/
            window.location.href = 'http://a.app.qq.com/o/simple.jsp?pkgname=com.tqmall.yunxiu';
        },
        ...
        changeSize: function () {
            ...
            this.height = parseInt(page.height());
        ...
        init: function () {
            this.changeSize();
            window.addEventListener('onorientationchange' in window ? 'orientationchange' : 'resize', this.changeSize);
            $('body').show();
        },
