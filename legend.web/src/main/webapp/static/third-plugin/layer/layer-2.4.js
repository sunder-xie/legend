...
//默认内置方法。
    ...
    var scrollbarWidth = function () {
        var w1, w2,
            div = $('<div style="display: block;position: absolute;left: -1204px;top: -1204px;width: 50px;height: 50px;overflow: hidden;"><div style="height: 100px;width: auto;"></div></div>'),
...
//创建骨架
    Class.pt.creat = function(){
        ...
        that.vessel(conType, function(html, titleHTML){
            ...
            if (!config.scrollbar) {
                // 针对当前系统进行微调，支持锁定body滚动
                cacheScrollbarWidth = cacheScrollbarWidth == null ? scrollbarWidth() : cacheScrollbarWidth;
                doms.html.css({'overflow': 'hidden', 'padding-right': cacheScrollbarWidth}).attr('layer-full', times);
                $('.yqx-header .header').css('padding-right', cacheScrollbarWidth);
            }
        }).auto(times);
    ...
    ready.rescollbar = function(index){
        if(doms.html.attr('layer-full') == index){
            if(doms.html[0].style.removeProperty){
                ...
                doms.html[0].style.removeProperty('padding-right');
                $('.yqx-header .header')[0].style.removeProperty('padding-right');
            } else {
                doms.html[0].style.removeAttribute('overflow');
                doms.html[0].style.removeAttribute('padding-right');
                $('.yqx-header .header')[0].style.removeAttribute('padding-right');
            }
