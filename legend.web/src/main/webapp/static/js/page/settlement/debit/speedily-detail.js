...
$(function(){
    ...
    seajs.use([
        ...
        $doc.on('click', '.js-debit', function () {
            var orderTag = $(this).data('tag');
            var payStatus = $(this).data('payStatus');
            if ((orderTag == 3 || orderTag == 5) && payStatus == 0) {
                window.location.href = BASE_PATH + "/shop/settlement/debit/speedily-confirm-bill?refer=order-detail&orderId=" + orderId;
            } else {
