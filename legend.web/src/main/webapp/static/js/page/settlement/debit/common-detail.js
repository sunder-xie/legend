...
$(function(){
    ...
    seajs.use([
        ...
        $doc.on('click','.js-confirm',function(){
            window.location.href = BASE_PATH + "/shop/settlement/debit/confirm-bill?orderId=" + orderId;
        });
        ...
        $(".js-print-new").click(function () {
            util.print(BASE_PATH + '/shop/settlement/shop-settle-print?orderId=' + orderId);
        });
