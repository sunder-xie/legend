...
$(function () {
    seajs.use(['date','table','art'], function (dp,tb,at) {
        ...
        //总额
        SmartAjax.get({
            url:'/legend/insurance/settle/console/getCashAmount',
...
function get_rest_table(tb){
    //分页
    init_table(tb,"/legend/insurance/settle/console/getDetailData","cash_table","pagingColumn","cacheTableTpl","orderSearchForm");
}
