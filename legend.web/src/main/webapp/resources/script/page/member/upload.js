$.extend({
    ...
    createUploadForm: function(id, selector, data)
	{
		//create form
  ...
  //      	$(oldElement).attr('id', fileId);
        ...
        $(selector).appendTo(form);


        // selector = selector.split(",");
        // for(var i=0;i<selector.length;i++){
        //    var oldElement = $(selector[i]);
    ...
    ajaxFileUpload: function(s) {
		...
		var form = $.createUploadForm(id, s.selector, (typeof(s.data)=='undefined'?false:s.data));
