...
define(function (require, exports, module) {
	...
	exports.get = function (formid) {
		...
		$(".form_item,.form_item_hidden", "#" + formid).each(function () {
			...
			var ddc = null;//如果有动态添加行，会使用此变量，该变量是json对象，代表每一个动态添加行对象
	...
	exports.get3 = function (scope) {
		...
		$("input,select,textarea", scope).each(function () {
			...
			//以下几种情况的值不做处理
			var elementArray = ['button', 'reset', 'submit', 'file'];
			if (elementArray.indexOf(type) != -1 || exclude != undefined) {
				return true;
			};
