...
;(function($){
    $.fn.addminusinputer  = function(option){
        //$.extend({}, obj1, obj2); 将后面的对象的内容合并到第一个对象
    ...
    $.fn.addminusinputer.addminusTaped = function(e){  
        var $btn = $(this);
        var nextValue = 0 ;
    ...
    $.fn.addminusinputer.updateValue = function(value){ 
        ...
        $inputer = $that.find( 'input[type=text]' + ( opts.inputerClass ? '.'+ opts.inputerClass : '' ) );
        $inputer.val(value);
