$(document).ready(function ($) {
    ...
    $("#bookPreviewFull").click(function(){
        var search_topicId = $("#search_topicId").val();
        var page = $("#page").val();
        var url = BASE_PATH+"/shop/tech/topic/preview_full?id="+search_topicId+"&page="+page;
        window.open(url);
    });
...
function getPageData(page) {
    ...
    $.ajax({
        type: 'get',
        dataType: 'json',
        url: BASE_PATH + '/shop/tech/topic/page_list',
        data: {
            search_topicId: search_topicId,
            page: page
        },
        cache: false,
