//这个模块是json 列表里的值，并返回这个值所在的对象
define("legend/resources/online/script/jsonSql-debug", [], function(requrie, exports, module) {
    module.exports = {
        ...
        returnFilter: function(json, jsonsql_o) {
            ...
            for (var jsonsql_i in jsonsql_scope) {
                with (jsonsql_scope[jsonsql_i]) {
                    //					console.log(jsonsql_o.where+" : "+eval(jsonsql_o.where));
