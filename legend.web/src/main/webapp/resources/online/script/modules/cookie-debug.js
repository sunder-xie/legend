//此模块是对cookie操作的模块
define("legend/resources/online/script/cookie-debug", [], function(require, exports, module) {
    var expiryHours = 24;
    module.exports = {
        setCookie: function(name, value, hours) {
            ...
            var expire = "";
            if (hours != null) {
                expire = new Date(new Date().getTime() + hours * 6e5);
            } else {
                expire = new Date(new Date().getTime() + expiryHours * 6e5);
            }
