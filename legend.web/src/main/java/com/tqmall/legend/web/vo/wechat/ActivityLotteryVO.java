...
@Getter
@Setter
public class ActivityLotteryVO {
    private Long id;
    ...
    private String lotteryStartTimeStr;
    ...
    private String lotteryEndTimeStr;
     ...
     * 抽奖活动设置的奖品列表
     */
    private List<ActivityLotteryPrizeVO> activityLotteryPrizeVOList;
}
